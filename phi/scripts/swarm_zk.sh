...
docker service create \
  ...
  -e ZOO_MY_ID=1 \
  -e ZOO_SERVERS="server.1=0.0.0.0:2888:3888;2181 server.2=10.1.10.6:2878:3878 server.3=10.1.10.7:2878:3878" \
...
docker service create \
  ...
  -e ZOO_MY_ID=2 \
  -e ZOO_SERVERS="server.1=10.1.10.5:2878:3878 server.2=0.0.0.0:2888:3888;2181 server.3=10.1.10.7:2878:3878" \
  --replicas 1 \
  zookeeper:3.5
docker service create \
  --name zk3 \
  ...
  --mount type=volume,source=zk-logs,target=/logs \
  -e ZOO_MY_ID=3 \
  -e ZOO_SERVERS="server.1=10.1.10.5:2878:3878 server.2=10.1.10.6:2878:3878 server.3=0.0.0.0:2888:3888;2181" \
